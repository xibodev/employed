...
1. **SSM params** under `/employed/prod/`:
   - Secrets/SecureStrings: `DATABASE_URL`, `SECRET_KEY`, `STRIPE_SECRET_KEY`, `STRIPE_WEBHOOK_SECRET`, `STRIPE_PUBLISHABLE_KEY`, `IP_SALT`, `RECAPTCHA_SECRET_KEY`, `NEXT_PUBLIC_RECAPTCHA_SITE_KEY`, `GOOGLE_CLIENT_ID`, `GOOGLE_CLIENT_SECRET`, `SMTP_USERNAME`, `SMTP_PASSWORD`, `CLOUDFLARED_TOKEN`, optional `SENTRY_DSN`.

...
| BL-012 | **CARTO-004:** move GHCR images `ghcr.io/mekjr1/employed-{api,frontend}` → `ghcr.io/xibodev/*` as part of the repo org migration. Do the whole lift-and-shift in one turn. | `planned` | operator | `architecture/repo-map.json` CARTO-004 |
